...
def get_opts():
    parser = argparse.ArgumentParser(description="PVG-DET")
    ...
    # model parameters
    parser.add_argument("--baseline", type=str, default="fcos", help="the baseline model (RetinaNet, FCOS)")
    parser.add_argument("--backbone", type=str, default="pvg_t", help="the backbone of the model")
