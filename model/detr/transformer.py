...
from model.detr.attention import MultiheadAttention
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, memory,
        ...
        num_queries, batch_size, d_model = tgt.shape
        output = tgt
        ...
        for layer_id, layer in enumerate(self.layers):
            ...
            query_sine_embed = gen_sineembed_for_position(obj_center, d_model)
